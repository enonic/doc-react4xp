...
<3> `maxThreads` specifies the number of (<<ssr#renderers, renderers>>) used for simultaneous SSR requests. Defaults to the number of processors cores available to XP. Be careful about setting this option
